...
import com.raven.bar.blankchart.BlankPlotBarChart;
import com.raven.bar.blankchart.BlankPlotBarChatRender;
import com.raven.bar.blankchart.BarSeriesSize;
...
public class BarChart extends javax.swing.JPanel {
    ...
    public BarChart() {
        ...
        blankPlotChart.setBlankPlotChatRender(new BlankPlotBarChatRender() {
            ...
            @Override
            public void renderSeries(BlankPlotBarChart chart, Graphics2D g2, BarSeriesSize size, int index) {
    ...
    private void initComponents() {
        ...
        blankPlotChart = new com.raven.bar.blankchart.BlankPlotBarChart();
    ...
    private com.raven.bar.blankchart.BlankPlotBarChart blankPlotChart;
