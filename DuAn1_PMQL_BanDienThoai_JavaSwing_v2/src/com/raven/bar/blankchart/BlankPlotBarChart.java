...
public class BlankPlotBarChart extends JComponent {
    ...
    private BarNiceScalee niceScale;
    ...
    public void initValues(double minValues, double maxValues) {
        ...
        this.maxValues = maxValues;
        niceScale = new BarNiceScalee(minValues, maxValues);
        repaint();
    }
    ...
    public BarSeriesSize getRectangle(int index, double height, double space, double startX, double startY) {
        double x = startX + space * index;
        BarSeriesSize size = new BarSeriesSize(x, startY+1, space, height);
        return size;
    }
